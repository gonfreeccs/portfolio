<template>
  <div class="banner-1">
    ...
    >
      <div class="flex items-center justify-between">
        <div class="relative w-16 h-16">
          <img
            ...
            src="src\assets\CAMILA, JOHN VINCENT SC SFTG _CSPC 1778 copy.jpg"
            alt="user image"
          />
        </div>
        <!-- Mobile menu button -->
      ...
      <ul
        ...
        class="flex-col items-end mt-0 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-8 md:mt-0"
      >
        <li class="menu-button"><a href="#">Home</a></li>
        <li class="menu-button"><a href="#work" v-smooth-scroll>Works</a></li>
        <li class="menu-button">
          <a href="#testimonial" v-smooth-scroll>Experiences</a>
        </li>
    ...
    <div class="flex items-center">
      <div class="w-11/12 space-y-10 md:space-y-11">
        <h3
        ...
        <h1
          class="3xl:text-8xl 2xl:text-7xl xl:text-5xl lg:text-4xl md:text-3xl sm:text-3xl text-xl font-Eczar font-bold leading-tight text-gray-700"
        >
          I'm
          <a
            href="https://www.linkedin.com/in/vince-camila-0b4149283/"
            target="_blank"
            class="text-black hover:underline"
          >
            JOHN VINCENT</a
          > 👨‍💻 <br />a Web App Developer
        </h1>
        ...
        <div class="md:flex gap-1 md:gap-10">
          ...
          <a href="#contact" v-smooth-scroll><button
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Department of Agrarian Reform (DAR) Camarines Sur II, Land Certificate Inventory</h4>
        <p class="font-work_sans pr-12">
          Designed to store via online the native documents which is 
          in a hard copy. This project also serves as easy allocation of 
          certificates for municipalities and year transacted.
        </p>
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Cebu Call Center Academy Inc., Iriga Branch Integrated System: Administration Management</h4>
        <p class="font-work_sans pr-12">
          Manages the DTR of trainers and
          document related works of admin officers.
        </p>
        <!-- <button class="text-sky-800 font-bold text-2xl tracking-wider">
          View Case Study
        </button> -->
  ...
  <div class="banner-1" id="testimonial">
    <div class="space-y-4 grid place-items-center mt-5">
      <h3 class="heading3">Experiences</h3>
    </div>
      ...
      <div class="relative">
        <div class="relative lg:flex rounded-lg shadow-2xl overflow-hidden">
          ...
          <div class="relative lg:w-7/12 bg-white">
            ...
            >
            <b><p>Department of Agrarian Refrom, Camarines Sur II</p></b>
            <br>
              <p>
        ...
        <div class="relative lg:flex rounded-lg shadow-2xl overflow-hidden">
          ...
          <div class="relative lg:w-7/12 bg-white">
            ...
            <div
              class="relative py-12 lg:py-24 px-8 lg:px-16 text-gray-700 leading-relaxed"
            >
            <b><p>Cebu Call Center Academy</p></b>
            <br>
              <p>
...
Hello, and thank you for visiting my portfolio website! My name is John Vincent Sc. Camila, and I am a passionate Web Developer/Programmer. 
I am dedicated to accomplish any web related works, and I'm excited to share my work and accomplishments with you. 
This portfolio is a hand-picked selection of my best work.
<br>
<br>
I've had the pleasure of working on a wide range of projects, including the Department of Agrarian Reform II Camarines Sur, 
which serves as an inventory of land certificates. 
Each project brought distinct difficulties and opportunity for me to improve and demonstrate my talents in areas such as web development. 
I am quite proud with the results, and I am happy to share the story behind these initiatives.
      </p>
      <br>

      <a href="https://drive.google.com/file/d/1CHaD9kDcRTpaXe58pg2JGyw44njdbHOg/view?usp=drive_link">
      <button class="text-sky-800 font-bold text-2xl tracking-wider">
        View my resume
      </button>
      </a>
  ...
  <div class="banner-1 flex h-full items-center" id="contact">
    <div class="w-7/12 p-12">
      <h2 class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold">
        Let’s work together and make an exciting project.
      </h2>
